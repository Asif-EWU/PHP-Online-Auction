...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2021 at 06:12 AM
...
(1, 'Asif Mohammad', '2017-1-60-043@std.ewubd.edu', '$2y$10$ZcoiN3XbApItPjNrFP0AZe9pJzdV/aH6lymw0ja77QWOh5URlGIfC', '180/F, East Rampura, Dhaka', 'Dhaka', 'Bangladesh', '880', 'male', '1996-01-28', 24);
...
(10004, 'Asif', 'a@gmail.com', '$2y$10$lWv5778txTesyXtXRZdwRu0qwxNO.CySEjduyRv2T6dWtBLpuefR.', 'Banasree, Dhaka', 'dhaka', 'Bangladesh', '880', 'male', '1990-01-01', 30),
(10005, 'Muhammad', 'm@gmail.com', '$2y$10$4QGRftaSFRV.TTqPQe7bhupNt828PhbSAIcnITIwC9lPlpCV0733K', 'Rampura, Dhaka.', 'Rajshahi', 'Bangladesh', '880', 'male', '1990-01-01', 30),
(10006, 'Ratul', 'r@gmail.com', '$2y$10$bMKcibs.Bg3tcuIrxD259.KmrVMn5sjsGb4BlvX0PfX3jGi18PQqq', 'East Rampura', 'Dhaka', 'Canada', '1', 'female', '1990-01-01', 30);
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10008;
